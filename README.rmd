...
progression-free survival (PFS). Jointly modeling the endpoints OS and PFS with the illness-death model has the major 
...
set-up allows random and event-driven censoring, an arbitrary number of treatment arms and staggered study entry.
Exponentially distributed, Weibull distributed and piecewise exponentially distributed survival times can be generated.
